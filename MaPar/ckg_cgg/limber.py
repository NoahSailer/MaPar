...
class limb():
   ...
   """
   def __init__(self, dNdz, Pgm, Pgg, Pmm, background, lmax=1000, Nlval=64, zmin=0.001, zmax=2., Nz=50):
      """
      Parameters
      ----------
      dNdz: str or ndarray
   ...
   def computeZeff(self,OmM=0.295):
      """
      ...
      """
      z = np.linspace(0.,self.zmax,5000); dz=z[1]-z[0]
